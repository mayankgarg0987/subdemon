...
def banner():
    bann = """
           _         _                            
 ___ _   _| |__   __| | ___ _ __ ___   ___  _ __  
/ __| | | | '_ \ / _` |/ _ \ '_ ` _ \ / _ \| '_ \ 
\__ \ |_| | |_) | (_| |  __/ | | | | | (_) | | | |
|___/\__,_|_.__/ \__,_|\___|_| |_| |_|\___/|_| |_|

               By- Mayank, Yash, Rishank, Shashank
...
def scan_subdomains(domain):
    ...
    while True:
        ...
        try:
            ...
            print(Fore.GREEN + "[+] Discovered subdomain: %-30s IP: %-30s STATUS CODE: %-30s" % (url, IP, res.status_code))  
